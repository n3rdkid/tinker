...
(6, 'How do you call a function in Javascript', 15),
(7, 'How do you update a function in Javascript', 15),
...
(11, 'Which of the following type of variable is visible everywhere in your JavaScript code', 20),
(12, 'Which built-in method combines the text of two strings and returns a new string?', 25),
(13, 'Which Number object formats a number with a specific number of digits to the right of the decimal?', 25),
(14, 'Which following function of Number object returns a string value version of the current number?', 25),
(15, 'Which String object executes search for match between regular expression and specified string?', 20),
(16, 'Which String object causes string to displayed as struck-out text, as if it were in a <strike> tag?', 15),
(17, '\'Which Array object creates new array with results calling function on every element in array?', 20),
(18, 'Which String object creates a string to be displayed as bold as if it were in a <b> tag?', 20);
...
(21, 'function = myFunction()', 7),
(22, 'function: myFunction()', 7),
(23, 'function myFunction()', 7),
(24, 'function() myFunction', 7),
(25, 'if i==5 then', 8),
(26, 'if i=5 then', 8),
(27, 'if (i==5)', 8),
(28, 'if i==5', 8),
...
(39, 'myFunction()', 6),
(40, 'call()', 6),
(41, 'Global variable', 11),
(42, 'Local Variable', 11),
(43, 'Both of the above', 11),
(44, 'None of the above', 11),
(45, 'append()', 12),
(46, 'concat()', 12),
(47, 'attach()', 12),
(48, 'None of the above', 12),
(49, 'toExponential()', 13),
(50, 'toFixed()', 13),
(51, 'toPrecision()', 13),
(52, 'toLocaleString()', 13),
(53, 'toString()', 14),
(54, 'toFixed()', 14),
(55, 'toLocaleString()', 14),
(56, 'toPrecision()', 14),
(57, 'concat()', 15),
(58, 'match()', 15),
(59, 'replace()', 15),
