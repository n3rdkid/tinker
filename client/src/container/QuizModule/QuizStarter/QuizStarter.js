...
class QuizStarter extends React.Component {
  ...
  render() {
    return (
      ...
      <Row className="no-gutters" style={{minHeight:"500px",background: "#FFF0A0" }}>
        <Col className="mt-5 ml-3 d-flex align-items-center" md="6">
          <div>
            <h1 style={{ fontSize: "2.44rem", color: "#211717" }}>
            Don't assume you know.<br/><span style={{fontSize: "4rem",color: "#ff6337" }}>TEST YOURSELF!</span>
            </h1>
      ...
      <Row className="no-gutters" style={{minHeight: "350px", background: "#525252" }}>
        ...
        >
          <div>
            ...
            >
               Don't just guess where your skills stand -<span style={{   color: "#f07b3f"}}>PROVE IT.</span>
            </h3>
        ...
        <NavLink style={{color:"white",fontSize:"1.5rem",  padding:"5px"}} onClick={this.quizStart}>
        <span style={{ borderBottom:"2px solid #f07b3f",  paddingBottom:"5px"}}>Take the Quiz <span style={{color:"#f07b3f"}}>></span></span>
          </NavLink>
        </Col>
      </Row>
    </Jumbotron>
